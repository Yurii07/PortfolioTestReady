			...
			<div class="row">
				<div class="col">
					<ul class="list">
						...
						<li class="list-item">
							<span class="item-bigsize">Оптимизация</span>
							<p>Залог нашего успеха — это соблюдение<br>
							стандартов</p>
						</li>
						<li class="list-item">
							<span class="item-bigsize">SEO-продвижение</span>
							<p>Лучшее продвижение сайта для<br>
							вашего бизнеса</p>
						</li>
					</ul>
